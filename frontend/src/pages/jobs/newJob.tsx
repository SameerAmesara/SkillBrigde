...
import { NewJobData, NewJobErrorData, experienceLevels, jobTypes, locationProvinces } from "../../models/jobs.model"
        ...
        <>
            ...
            >
                ...
                <Box sx={{ ...textInputCard }}>
                    <InputTitle title="Title" description="Be specific while choosing a title for your job" />
                    <InputTextSingleLine
                    ...
                    <InputTitle title="Description" description="Share details about the job and its qualification" />
                    <InputTextMultiLine
                    ...
                    <InputTitle title="Company Details" description="Tell us about your workplace, benefits and more" />
                    <TextField
                        multiline
                        rows="8"
