...
import { Container, Typography, Grid, Stack, Chip, Card, Link, Box, 
 Button, CssBaseline } from '@mui/material';
...
export default function LandingPage() {
  ...
  const subtitle1 = "Unlock endless possibilities with SkillBridge, the ultimate platform for networking and learning. Join a vibrant community of like-minded individuals, where connections flourish, and knowledge thrives.";
  const title2 = "Explore, Learn, Connect!";
  const subtitle2 = "Ready to take your career to new heights? Join to embark on a journey of learning and networking."
  const items = [
    {
